...
export default async function SettingsPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <AppShell title="Configuracion" subtitle="Empresa, usuarios, roles y permisos operativos.">
      <div className="grid gap-6 xl:grid-cols-[0.8fr_1.2fr]">
        ...
        <Card>
          <CardHeader title="Usuarios y permisos" description="ADMIN, SUPERVISOR y SELLER." />
